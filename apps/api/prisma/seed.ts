...
async function seed() {
  ...
  console.log(chalk.red('✅ Deleted all organizations and users.'))
  ...
  console.log(chalk.green('✅ Created users'))
  ...
  console.log(chalk.green('✅ Created organizations and projects'))
}
